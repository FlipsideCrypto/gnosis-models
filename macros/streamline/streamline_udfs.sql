{% macro create_udf_get_chainhead() %}
    ...
    {% if target.name == "prod" %}
        aws_gnosis_api AS 'https://abjc1ljs1d.execute-api.us-east-1.amazonaws.com/prod/get_chainhead'
    {% else %}
...
{% macro create_udf_bulk_json_rpc() %}
    ...
    OR REPLACE EXTERNAL FUNCTION streamline.udf_bulk_json_rpc(
        ...
        aws_gnosis_api AS 'https://abjc1ljs1d.execute-api.us-east-1.amazonaws.com/prod/udf_bulk_json_rpc'
    {% else %}
...
{% macro create_udf_decode_array_string() %}
    ...
    OR REPLACE EXTERNAL FUNCTION streamline.udf_decode(
        ...
        aws_gnosis_api AS 'https://abjc1ljs1d.execute-api.us-east-1.amazonaws.com/prod/decode_function'
    {% else %}
...
{% macro create_udf_decode_array_object() %}
    ...
    OR REPLACE EXTERNAL FUNCTION streamline.udf_decode(
        ...
        aws_gnosis_api AS 'https://abjc1ljs1d.execute-api.us-east-1.amazonaws.com/prod/decode_log'
    {% else %}
...
{% macro create_udf_bulk_decode_logs() %}
    ...
    OR REPLACE EXTERNAL FUNCTION streamline.udf_bulk_decode_logs(
        ...
        aws_gnosis_api AS 'https://abjc1ljs1d.execute-api.us-east-1.amazonaws.com/prod/bulk_decode_logs'
    {% else %}
