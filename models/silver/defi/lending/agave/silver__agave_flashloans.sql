...
flashloan AS (
    SELECT
        ...
        CONCAT('0x', SUBSTR(topics [3] :: STRING, 27, 40)) AS agave_market,
...
FROM
    ...
    ON flashloan.agave_market = atoken_meta.underlying_address qualify(ROW_NUMBER() over(PARTITION BY _log_id
ORDER BY
